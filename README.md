...
Este aplicativo contiene un proyecto llamado CAR REPAIR PRO, el cual es una aplicación para gestión de ordenes de servicio en un taller automotriz.  Contiene la evolución del repositorio CarRepairPro_GA7_AA2_EV02. En esta fase del proyecto se espera llegar desarrollar una versión más práctica para el despliegue en ambientes tanto de pruebas como producción.
